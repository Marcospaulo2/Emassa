...
<head>
    ...
    <link rel="shortcut icon" href="/img/sanfonacamada.png" type="image/x-icon">
    
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-uWxY/CJNBR+1zjPWmfnSnVxwRheevXITnMqoEIeG1LJrdI0GlVs/9cVSyPYXdcSF" crossorigin="anonymous">
    <title>Camarote SJ Maceió</title>
...
<body>
    <header>
            ...
            <div class="nav-container">
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                    <div class="offcanvas-header">
                        <h5 class="offcanvas-title" id="offcanvasNavbarLabel"><img src="img/sanfonacamada.png" width="40%"></h5>
                        <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                    </div>
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            <li class="nav-item">
                                <a target="_black" href="https://www.evenyx.com/camarote-e-massa">COMPRAR INGRESSO</a>
                            </li>
                            <!-- <li class="nav-item">
        ...
        <div class="tamandare-icon">
            <img  heid src="img/sanfonacamada.png">
        </div>
    </header>
    <div class="banner">
        <img src="img/e-massa.png">
        <!-- <div class="banner-icon">
            <img src="./img/Grupo4.png">
        </div> -->
    </div>
    <div class="comprar-btn">
        <a target="_blanck" href="https://www.evenyx.com/camarote-e-massa">
